...
<!-- When the user clicks the 'Save User' button, the input 
form will be submitted to the same page. So on that same 
form.php page, we are including a processForm.php file 
which contains the code to process our form. -->